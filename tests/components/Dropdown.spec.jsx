...
describe('Dropdown', () => {
  ...
  it('should not call props.toggle when disabled ', () => {
    ...
    const wrapper = mount(<Dropdown isOpen={isOpen} toggle={props.toggle} disabled>
      <DropdownToggle>Toggle</DropdownToggle>
      <DropdownMenu>
        <DropdownItem>Test</DropdownItem>
      </DropdownMenu>
  ...
  describe('handleDocumentClick', () => {
    it('should call toggle on document click', () => {
      ...
      mount(<Dropdown isOpen={isOpen} toggle={toggle}>
        <DropdownToggle>Toggle</DropdownToggle>
        <DropdownMenu right>
          <DropdownItem>Test</DropdownItem>
        </DropdownMenu>
  ...
  it('should render different size classes', () => {
    const small = mount(<Dropdown group isOpen={isOpen} size="sm" toggle={toggle}>
      <DropdownToggle>Toggle</DropdownToggle>
      <DropdownMenu>
        <DropdownItem>Test</DropdownItem>
      </DropdownMenu>
    ...
    const large = mount(<Dropdown group isOpen={isOpen} size="lg" toggle={toggle}>
      <DropdownToggle>Toggle</DropdownToggle>
      <DropdownMenu>
        <DropdownItem>Test</DropdownItem>
      </DropdownMenu>
